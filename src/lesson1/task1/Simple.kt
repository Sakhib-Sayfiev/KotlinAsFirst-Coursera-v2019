 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg * 3600 + min * 60 + sec) * PI / (3600 * 180)
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val temp_trash: Int = initial + (initial * percent) / 100
    var temp: Double = temp_trash.toDouble()
